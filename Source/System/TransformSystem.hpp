...
public:
	...
	void Rotate(entt::registry& registry, entt::entity& entity, glm::vec3& rotateVec, float rotationDegree);

	void Translate(entt::registry& registry, entt::entity& entity, glm::vec3& translateVec);
